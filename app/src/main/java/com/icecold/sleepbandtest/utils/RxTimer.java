...
/**
 * @Description: 通过RxJava2实现的一个定时器工具
...
public class RxTimer {
    ...
    /**
     * 每隔milliseconds毫秒后执行指定动作可设置开始的初始值和结束值
     * @param start 初始值
     * @param end 结束值(不包含这个值)
     * @param milliSeconds 毫秒
     * @param rxAction //回调
     */
    public void intervalRange(int start,int end,long milliSeconds,final RxAction rxAction){
        Observable.intervalRange(start,end,0,milliSeconds, TimeUnit.MILLISECONDS)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<Long>() {
                    @Override
